...
export type ForexClosed = { instrument: string; direction: string; lot: number; harga_entry: number; harga_exit: number | null; net_pnl: number | null; persen_profit_loss: number | null; tanggal_buka: string; tanggal_tutup: string | null; desk: string };
